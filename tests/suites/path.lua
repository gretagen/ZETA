...
suite:test("symlink_escapes allows absolute targets, rejects escaping relative targets", function()
  lib.assert_false(path.symlink_escapes("usr/lib/x", "/etc/passwd"))
